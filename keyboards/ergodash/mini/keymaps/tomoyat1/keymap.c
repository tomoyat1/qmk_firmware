...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_RAISE] = LAYOUT(
    ...
    KC_TRNS, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, KC_INS ,                        KC_TRNS, KC_AMPR, KC_1   , KC_2   , KC_3   , KC_QUES, KC_TRNS, \
   ...
   */
  [_VIM] = LAYOUT(
    _______, _______, _______, _______, _______, _______,_______,                       _______, COPY   , UNDO   , VIM_NRM,_______, PASTE  , _______, \
